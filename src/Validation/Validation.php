...
use Closure;
use Nexius\Validation\Rules\Interfaces\BeforeValidate;
use Nexius\Validation\Rules\Interfaces\ModifyValue;
use Nexius\Validation\Rules\Required;
...
class Validation
{
     ...
     * Constructor
     *
     * @param \Nexius\Validation\Validator $validator
     * @param array $inputs
     * @param array $rules
     ...
     *
     * @param string $attributeKey
     * @return null|\Nexius\Validation\Attribute
     */
     ...
     *
     * @return \Nexius\Validation\ErrorBag
     */
     ...
     * Validate attribute
     *
     * @param \Nexius\Validation\Attribute $attribute
     * @return void
     */
    protected function validateAttribute(Attribute $attribute)
    {
        ...
        if (($attribute->hasRule('nullable') || ($attribute->hasRule('sometimes') && request()->getMethod() == 'PUT')) && $isEmptyValue) {
            return;
        }
     ...
     * @param \Nexius\Validation\Attribute $attribute
     * @param mixed $value
     * @param \Nexius\Validation\Rule $ruleValidator
     * @return void
     */
     ...
     *
     * @param \Nexius\Validation\Attribute $attribute
     * @param \Nexius\Validation\Rule $rule
     * @return bool
     */
     ...
     * @param \Nexius\Validation\Attribute $attribute
     * @param mixed $value
     * @param \Nexius\Validation\Rule $validator
     * @return mixed
     */
     ...
     *
     * @return \Nexius\Validation\Validator
     */
