...
use Nexius\Validation\MissingRequiredParameterException;
...
abstract class Rule
{
    ...
    /** @var \Nexius\Validation\Attribute|null */
    protected $attribute;

    /** @var \Nexius\Validation\Validation|null */
     ...
     *
     * @param \Nexius\Validation\Validation $validation
     * @return void
     */
     ...
     * Get attribute
     *
     * @return \Nexius\Validation\Attribute|null
     */
     ...
     * @param array $params
     * @return void
     * @throws \Nexius\Validation\MissingRequiredParameterException
     */
